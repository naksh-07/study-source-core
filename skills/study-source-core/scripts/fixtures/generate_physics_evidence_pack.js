 ...
 * from a raw Physics source fixture.
 */
...
function generatePhysicsEvidencePack(fixtureOrPath, outputDir = null) {
    ...
    lines.push('- Domain: ' + (fixture.domain || 'Physics'));
    lines.push('- Topic: ' + (fixture.topic || 'Mechanics'));
    lines.push('- Skill ID: ' + (fixture.skill_id || 'physics.mechanics.work_energy_power'));
    ...
    const provenanceMetadata = {
        source_name: fixture.source_provenance ? fixture.source_provenance.source_title : 'Physics Source Fixture',
        ...
        detected_subject: fixture.subject || 'Physics',
        chapter_title: fixture.chapter || 'Work-Energy-Power'
    };
