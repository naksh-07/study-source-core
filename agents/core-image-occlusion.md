...
- Invoked in **Wave 1 (Parallel Generation)** when `io_worthiness >= threshold AND io_candidates > 0`; suppressed with `NO_IO_CANDIDATES` or `IO_WORTHINESS_BELOW_THRESHOLD`.
